...
> 5 community-built skills curated by [cue](https://github.com/opencue/claude-code-skills) for the **cybersecurity** profile.
...
**★ 2** · exceptional (score 14.5) · Python · tags: adversarial-testing, ai-code-review, architecture-review, claude-code, claude-code-skill
...
**★ 1588** · exceptional (score 11.1) · Python · tags: agentskills, claude, skills
